...
\begin{tablenotes}
            \footnotesize
            \item Multiple Switching: A dummy variable equal to 1 if participant switches multiple times during a given round.
...
\begin{table}[H]
      ...
      \hline \hline
            &\multicolumn{2}{c}{WTP (BDM Real: baseline)}    \\
            \hline
Constant    &       8.480\sym{***}&     (0.548)\\
Hypothetical&       0.738         &     (0.720)\\
Round2      &      -0.180         &     (0.431)\\
Round3      &      -0.006         &     (0.452)\\
HypotheticalXRound2&      -0.388         &     (0.704)\\
HypotheticalXRound3&      -0.743         &     (0.681)\\
Ln\_Time     &      -0.684\sym{***}&     (0.066)\\
HypotheticalXLn\_Time&      -0.065         &     (0.092)\\
Ln\_TimeXRound2&      -0.004         &     (0.056)\\
Ln\_TimeXRound3&      -0.032         &     (0.058)\\
HypotheticalXRound2XLn\_Time&       0.039         &     (0.094)\\
HypotheticalXRound2XLn\_Time&       0.063         &     (0.089)\\
White       &      -0.097         &     (0.082)\\
Middle Income&      -0.094         &     (0.083)\\
High Income &       0.271\sym{*}  &     (0.149)\\
Midwest     &      -0.080         &     (0.114)\\
South       &      -0.039         &     (0.109)\\
West        &      -0.078         &     (0.120)\\
Female      &      -0.074         &     (0.072)\\
Bachelor    &      -0.225\sym{***}&     (0.082)\\
No Children &       0.152\sym{*}  &     (0.087)\\
Married     &      -0.137\sym{*}  &     (0.082)\\
Age         &       0.014\sym{***}&     (0.003)\\
\hline
$\sigma_u $    &       0.920\sym{***}&     (0.032)\\
$\sigma_e $     &       0.708\sym{***}&     (0.027)\\
