...
\multirow{2}{*}{$\frac{\partial y}{\partial GSO}$} & $Hypo=1$ &0.300*** &0.0705& [0.162, 0.438] &0.337***&0.075 & [0.190, 0.485]\\
...
Given that our results provide evidence in favor of hypothetical bias under the GSO mechanism, we proceed to analyze the underlying factors driving this bias. Specifically, we examine six potential mechanisms that may explain such bias: (1) differences in mechanism comprehension \hl{maybe cite here Cason and Plott?}, (2) social desirability bias \citep{lopez2021social, norwood2011social,bursztyn2025social}, (3) familiarity with the products \citep{fox1998cvm, veettil_hypothetical_2024}, (4) multiple switching behavior \footnote{Since some studies suggest that MSB can represent low decision quality, we also investigate if it is a driver of the hypothetical bias found in the GSO \citep{yu2021multiple}.}, (5) learning \hl{learning is constant across both mechanisms, so we mean here ease of learning or speed of learning?} and (6) attention allocation. Each represents a different pathway through which hypothetical bias may be moderated.


\subsubsection{Participants' understanding of the mechanism and game form recognition}
\hl{I think this has to be put in simpler words e.g., We measured perceived complexity to the mechanism by asking respondent..... 

what is in this section is ut in a way that is not transparent what we did. Start with the way we measure complexity. Then report average complexity per mechanism or a tabulation etc. Then a test. I think table A5 is unecessary, just report the mean inline. Why does table A5 has 3678 observations? if the measure is repeated because of the rounds, then you just restrict sample to round 1 and also adjust the test. But all of these does not need a table.

also the measures reported in Table a8, are not obvious you should mention here how these were measured. Again we dont need a table.
}
We first measure whether GSO leads to higher game form recognition--defined as participants’ understanding of the mapping between their strategy profile (or choice) and the resulting outcomes--  as compared to BDM. We conducted a chi-square test to compare proportion of participants who find that the elicitation mechanism is complex in BDM and GSO. The result also confirms that a higher proportion of people in the BDM report high difficulty understand it as compared to GSO (see Table~\ref{tab:Appendix_proportion_test} in Appendix). Additionally--as shown in table \ref{tab:Appendix_gameform} in appendix--we analyze participants perceived complexity of the mechanism, the result suggests that participants in the BDM report a higher level perceived complexity as compared to GSO. Additionally, we measured choice certainty, as how often participants feel like changing their bids. Using this metric, we find GSO leads to a higher choice certainty as compared to BDM.
...
\toprule
 & & \multicolumn{3}{c}{\makecell{Model (4) \\ (w/ demographics)}} \\
 & &Round \#& Marginal effect & Std. Error & CI \\ \midrule
\multirow{3}{*}{$\frac{\partial y}{\partial Hypo}$} & $GSO=0$ &  1& -0.04 & 0.07 & [-0.19, 0.0.10] \\
                                                     & $GSO=1$ &  1&0.38**** &  0.11& [0.16, 0.60] \\ \midrule
\multirow{2}{*}{$\frac{\partial y}{\partial Hypo}$} & $GSO=0$ &  2 & 0.07 & [-0.22, 0.08] \\
                                                      & $GSO=1$ & 2 &0.24** & 0.11 & [0.035, 0.46] \\ 
                                                      \midrule
\multirow{2}{*}{$\frac{\partial y}{\partial Hypo}$} & $GSO=0$ &  3&0.03 & 0.08 & [-0.12, 0.19] \\
...
\begin{tabular}{llccc}
\toprule
 & & \multicolumn{3}{c}{\makecell{Model (5) \\ (w/ demographics)}} \\
 & & Marginal effect & Std. Error & CI \\ \midrule
\multirow{2}{*}{$\frac{\partial y}{\partial GSO}$} & $Hypo=0$ & 0.006 & 0.08 & [-0.15, 0.16] \\
                                                     & $Hypo=1$ & 0.28**** &  0.076& [0.13, 0.43] \\ \midrule
\multirow{2}{*}{$\frac{\partial y}{\partial Hypo}$} & $GSO=0$ & -0.03 & 0.07 & [-0.17, 0.11] \\
...
\toprule
 ...
 & & Marginal effect & Std. Error & CI \\ \midrule
\multirow{2}{*}{$\frac{\partial y}{\partial Hypo}$} & $GSO\_above=0$ & 0.24** & 0.1 & [0.04, 0.0.43] \\
                                                     & $GSO\_above=1$ & 0.137 &  0.13& [0.11, 0.39] \\ \midrule
\multirow{2}{*}{$\frac{\partial y}{\partial GSO\_above}$} & $GSO=0$ & -0.98*** & 0.1& [-1.18, -0.79] \\
...
\hline
BDM            & 3,678        & 0.41     & 0.008           &            &                 & [0.40, 0.43]                             \\
GSO            & 3,426        & 0.366     & 0.008          &            &                 & [0.35, 0.38]                               \\
\hline
...
\begin{table}[htbp!]
    ...
    \begin{tabular}{lcccccc}
\hline\hline
\textbf{Group} & \textbf{Obs} & \textbf{Mean} & \textbf{Std. Err.} & \textbf{z} & \textbf{$P>|z|$} & \textbf{95\% Conf. Interval} \\
\hline
Non-MSB             & 3,112        & 0.345        & 0.008              &            &                  & [0.33, 0.36]                    \\
MSB              & 314        & 0.57        & 0.027              &            &                  & [0.52, 0.62]                    \\
\hline
\textbf{Diff}  &              & -0.23       & 0.03              & -8.84      & 0.000            & [-0.1718, -0.1086]                  \\
\hline\hline
    \end{tabular}
    }
    \begin{tablenotes}
        \footnotesize
        \item MSB: Multiple switching behavior
        \item Non-MSB: Non-multiple switching behavior
    \end{tablenotes}
\end{table}
...
\clearpage
 ...
 \begin{table}[H]
  ...
  \hline\hline
            ...
            \hline
Constant    &       3.764\sym{***}&     (0.249)&       2.768\sym{***}&     (0.147)\\
Hypothetical&       0.159         &     (0.243)&       0.081         &     (0.128)\\
Test\_score  &      -0.099\sym{***}&     (0.032)&       0.053\sym{***}&     (0.014)\\
Hypothetical$\times$Test\_score&       0.025         &     (0.043)&       0.008         &     (0.024)\\
Round2      &       0.034         &     (0.050)&       0.059         &     (0.054)\\
Round3      &       0.055         &     (0.055)&       0.120\sym{**} &     (0.055)\\
GSOMSB    &       0.375\sym{***}&     (0.127)&                     &            \\
White       &      -0.050         &     (0.099)&      -0.040         &     (0.051)\\
Middle Income&      -0.015         &     (0.098)&      -0.106\sym{**} &     (0.052)\\
High Income &       0.377\sym{**} &     (0.179)&      -0.243\sym{***}&     (0.094)\\
Midwest     &      -0.045         &     (0.133)&      -0.267\sym{***}&     (0.074)\\
South       &      -0.010         &     (0.125)&      -0.142\sym{**} &     (0.067)\\
West        &      -0.055         &     (0.135)&      -0.150\sym{**} &     (0.074)\\
Female      &      -0.059         &     (0.087)&       0.095\sym{**} &     (0.046)\\
Bachelor    &      -0.201\sym{**} &     (0.100)&       0.106\sym{**} &     (0.052)\\
No Children &       0.214\sym{**} &     (0.106)&      -0.125\sym{**} &     (0.053)\\
Married     &      -0.187\sym{*}  &     (0.098)&       0.080         &     (0.051)\\
Age         &       0.006\sym{**} &     (0.003)&       0.011\sym{***}&     (0.001)\\
sigma\_u     &       1.119\sym{***}&     (0.033)&                     &            \\
sigma\_e     &       0.832\sym{***}&     (0.036)&                     &            \\
\hline
...
\begin{table}[htbp!]
    ...
    \begin{tabular}{lcccc}
    \toprule
    \textbf{Variable} & \textbf{Group} & \textbf{Mean} & \textbf{Std. Dev.} & \textbf{p-value} \\
    \midrule
...
GSOMSB      &       0.213         &     (0.219)\\
Hypothetical\_GSOMSB&       0.302         &     (0.267)\\
Round2      &       0.035         &     (0.050)\\
Round3      &       0.055         &     (0.055)\\
White       &      -0.068         &     (0.098)\\
...
\begin{table}[H]
     ...
     \hline \hline
            &\multicolumn{2}{c}{WTP (GSO)}    &\multicolumn{2}{c}{WTP (BDM)}    \\
            \hline
Constant    &       3.405\sym{***}&     (0.210)&       3.088\sym{***}&     (0.123)\\            
Hypothetical&       0.382\sym{***}&     (0.113)&      -0.040         &     (0.075)\\
Round2      &       0.091         &     (0.068)&       0.075         &     (0.078)\\
Round3      &       0.100         &     (0.073)&       0.081         &     (0.079)\\
HypotheticalXRound2&      -0.133         &     (0.103)&      -0.032         &     (0.108)\\
HypotheticalXRound3&      -0.149         &     (0.111)&       0.076         &     (0.109)\\
White       &      -0.071         &     (0.099)&      -0.023         &     (0.051)\\
Middle Income&      -0.069         &     (0.099)&      -0.102\sym{*}  &     (0.053)\\
High Income &       0.348\sym{*}  &     (0.181)&      -0.253\sym{***}&     (0.094)\\
Midwest     &      -0.087         &     (0.134)&      -0.251\sym{***}&     (0.074)\\
South       &      -0.017         &     (0.127)&      -0.136\sym{**} &     (0.067)\\
West        &      -0.065         &     (0.136)&      -0.141\sym{*}  &     (0.074)\\
Female      &      -0.088         &     (0.086)&       0.106\sym{**} &     (0.046)\\
Bachelor    &      -0.238\sym{**} &     (0.100)&       0.120\sym{**} &     (0.051)\\
No Children &       0.188\sym{*}  &     (0.106)&      -0.131\sym{**} &     (0.053)\\
Married     &      -0.216\sym{**} &     (0.098)&       0.064         &     (0.051)\\
Age         &       0.006\sym{**} &     (0.003)&       0.011\sym{***}&     (0.001)\\
$\sigma_u$     &       1.139\sym{***}&     (0.033)&                     &            \\
$\sigma_e$     &       0.834\sym{***}&     (0.036)&                     &            \\
\hline
\(n\)  (observations)    &        3288         &            &        3540         &            \\
...
\midrule
n (observations)         & 1,734 & 1,692 & 1,860 & 1,818 \\
Rank sum                 & 2,875,169.5 & 2,995,281.5 & 3,407,394 & 3,358,287 \\
Expected rank sum        & 2,971,209 & 2,899,242 & 3,421,470 & 3,344,211 \\
Test statistic ($z$)     & \multicolumn{2}{c}{-3.318} & \multicolumn{2}{c}{-0.607} \\
$p$-value (two-sided)    & \multicolumn{2}{c}{0.0009} & \multicolumn{2}{c}{0.5437} \\
\hline\hline
\end{tabular}%
}
\end{table}
...
\hline\hline
            ...
            &\multicolumn{2}{c}{Time spent (GSO)}&\multicolumn{2}{c}{Time spent (BDM)}\\
\hline
Constant    &    6993.104\sym{***}&  (2700.820)&    2416.672\sym{**} &  (1151.090)\\
Hypothetical&   -4657.330         &  (3048.864)&    -261.345         &   (963.704)\\
Round2      &   -5107.747\sym{*}  &  (3007.002)&       0.000         &  (1144.440)\\
Round3      &   -5246.861\sym{*}  &  (3024.441)&       0.000         &  (1144.440)\\
HypotheticalXRound2&    4001.052         &  (3034.306)&      -0.000         &  (1361.329)\\
HypotheticalXRound3&    3960.690         &  (3058.031)&      -0.000         &  (1361.329)\\
White       &   -1618.570         &  (1139.066)&   -1701.997\sym{***}&   (578.387)\\
Middle Income&    -616.098         &   (785.359)&     172.379         &   (588.330)\\
High Income &   -1918.023\sym{***}&   (661.232)&   -2112.900\sym{***}&   (756.596)\\
Midwest     &     726.875         &   (626.357)&    1105.058         &   (825.990)\\
South       &    1511.634         &  (1589.151)&    -155.057         &   (688.486)\\
West        &     133.934         &   (643.639)&    -137.564         &   (561.473)\\
Female      &   -1263.489         &  (1005.752)&    -670.911         &   (630.176)\\
Bachelor    &    2935.663\sym{**} &  (1492.900)&    2700.808\sym{***}&   (560.380)\\
No Children &   -1719.554         &  (1510.704)&    -437.982         &   (580.198)\\
Married     &    2161.985         &  (1318.887)&   -1414.400\sym{**} &   (669.731)\\
Age         &      41.184\sym{***}&    (12.803)&      75.591\sym{***}&    (17.438)\\
...
\begin{table}[H]
             ...
             \begin{tabular}{l*{3}{cc}}
             \hline \hline
            &\multicolumn{2}{c}{WTP     (No interaction)}    &\multicolumn{2}{c}{WTP (Time interaction)}    &\multicolumn{2}{c}{WTP (Time interaction)}    \\
...
\begin{table}[H]
        \centering
        \caption{Comparison of Willingness to Pay by MS in GSO across rounds}        \label{tab:interval_regression_Time2}
       \resizebox{0.7\textwidth}{!}{% Scale table to fit the column width
      \begin{tabular}{l*{1}{cc}}
      \hline \hline
            &\multicolumn{2}{c}{WTP}    \\
Constant    &       3.397\sym{***}&     (0.212)\\
Hypothetical&       0.370\sym{***}&     (0.118)\\
Round2      &       0.072         &     (0.070)\\
Round3      &       0.115         &     (0.080)\\
HypotheticalXRound2&      -0.123         &     (0.103)\\
HypotheticalXRound3&      -0.176         &     (0.122)\\
White       &      -0.097         &     (0.101)\\
Middle Income&      -0.070         &     (0.101)\\
High Income &       0.361\sym{*}  &     (0.186)\\
Midwest     &      -0.051         &     (0.144)\\
South       &      -0.001         &     (0.131)\\
West        &      -0.060         &     (0.144)\\
Female      &      -0.108         &     (0.090)\\
Bachelor    &      -0.239\sym{**} &     (0.096)\\
No Children &       0.144         &     (0.101)\\
Married     &      -0.189\sym{*}  &     (0.097)\\
Age         &       0.008\sym{**} &     (0.003)\\
sigma\_u     &       1.155\sym{***}&     (0.034)\\
sigma\_e     &       0.832\sym{***}&     (0.034)\\
\hline
\(n\) (observations)       &        2863         &            \\
\hline \hline
\end{tabular}
