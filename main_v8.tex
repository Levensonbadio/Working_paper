...
\toprule
 & & \multicolumn{3}{c}{ \makecell{ \\ Specification \\ w/o demographics}} & \multicolumn{3}{c}{\makecell{\\ Specification \\ w/ demographics}} \\
...
\begin{tabular}{llccc}
\toprule
 & & \multicolumn{3}{c}{\makecell{Specification \\ w/ demographics}} \\
 & & M.E & Std. Error & CI \\ \midrule
\multirow{2}{*}{$\frac{\partial y}{\partial GSO}$} & $Hypo=1$ & 0.279*** &  0.076& [0.130, 0.428] \\ & $Hypo=0$ & 0.006 & 0.081 & [-0.153, 0.165] \\
                                                     \midrule
\multirow{2}{*}{$\frac{\partial y}{\partial Hypo}$}& $GSO=1$ & 0.243*** &  0.089 & [0.069, 0.417]\\ & $GSO=0$ & -0.029 & 0.070 & [-0.167, 0.108] \\
                                                       \bottomrule
\end{tabular}
\begin{tablenotes}
\footnotesize
...
%\hl{They show no differences since round 1, so I believe this is a mischaracterization of saying there is no learning. It also goes completely against every published paper in the BDM that shows improvements with learning. Also there is no realization of the BDM so there is no opportunity for learning.}
...
% In this article, we were not able to identify valuations beyond the third round, given that we only used three rounds of bidding task. For future applications of the GSO mechanisms, it would be beneficial to include additional rounds to better capture the trajectory of valuations over time.
...
\multirow{3}{*}{$\frac{\partial y}{\partial Hypo}$}& $GSO=1$ &  1&0.377*** &  0.107& [0.167, 0.587] \\ & $GSO=0$ &  1& -0.044 & 0.079 & [-0.200, 0.110] \\
                                            \midrule
\multirow{2}{*}{$\frac{\partial y}{\partial Hypo}$} & $GSO=1$ & 2 &0.242** & 0.101 & [0.043, 0.441] \\  & $GSO=0$ &  2 & -0.076& 0.078& [-0.230, 0.077] \\
                                       
                                      \midrule
\multirow{2}{*}{$\frac{\partial y}{\partial Hypo}$}& $GSO=1$ & 3&0.226** & 0.104 & [0.022 0.431] \\  & $GSO=0$ &  3&0.031 & 0.083 & [-0.131, 0.194] \\
...
\toprule
 & & \multicolumn{4}{c}{\makecell{Model \\ (w/ demographics)}} \\
